 ...
 *
 * @note
 *  Este arquivo define apenas as estruturas de dados.
 */
...
typedef struct {
    ...
    char vendor_name[17];                  /* 16 chars + null terminator */
    ...
    char vendor_pn[17];                    /* 16 chars + null terminator */

    /* Bytes 56-59: Vendor Revision (ASCII) */
    char vendor_rev[5];                    /* 4 chars + null terminator */

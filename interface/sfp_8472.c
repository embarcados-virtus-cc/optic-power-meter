...
{
    /* Bits 2 e 3 indicam cabo passivo/ativo */
...
void sfp_parse_a0_base_cc_base(const uint8_t *a0_base_data, sfp_a0h_base_t *a0)
{
    ...
    /* Byte 63 contém o checksum esperado */
...
void sfp_parse_a0_base_vendor_info(const uint8_t *a0_base_data, sfp_a0h_base_t *a0)
{
    ...
    /* Vendor Name: Bytes 20-35 (16 chars) */
    ...
    /* Vendor Part Number: Bytes 40-55 (16 chars) */
    memcpy(a0->vendor_pn, &a0_base_data[40], 16);
    a0->vendor_pn[16] = '\0';

    /* Vendor Revision: Bytes 56-59 (4 chars) */
    memcpy(a0->vendor_rev, &a0_base_data[56], 4);
    a0->vendor_rev[4] = '\0';

    /* Wavelength: Bytes 60-61 (big-endian) */
